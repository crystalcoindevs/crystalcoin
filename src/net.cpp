...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("CrystalCoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CrystalCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
	{"198.24.177.17", "198.24.177.17"},
    {"64.147.232.163", "64.147.232.163"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("CrystalCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("CrystalCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("CrystalCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("CrystalCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CrystalCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("CrystalCoin-start");
